...
/* this servlet is accessed by the url ${context}/addTutorialPage */
@WebServlet("/addTutorialPage")


public class AddTutorialPage extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.getRequestDispatcher("jsp/addTutorialPage.jsp").forward(request,response);
    }
